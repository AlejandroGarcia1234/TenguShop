...
<div class="relative mb-6">
    ...
    <div class="absolute top-8 right-8">
        <label class="flex item-center bg-white px-4 py-2 rounded-lg cursor-pointer">
            <i class="fas fa-camera mr-2"></i>
            Actualizar imagen

            <input name="image" class="hidden" type="file" accept="image/*" name="image" onchange="previewImage(event, '#imgPreview')">
        </label>
    </div>
</div>
...
<div class="card">
    <div class="mb-4">
        ...
        <x-input class="w-full" name="sku" value="{{old('sku', $variant->sku)}}" placeholder="Ingrese el código (SKU)"/>
