                ...
                <div class="p-6 rounded-lg border border-gray-200 relative">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        @switch($option->type)
                            ...
                            <span class="bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-400 border border-gray-500">{{$feature->description}}</span>
