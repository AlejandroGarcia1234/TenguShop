<div>
                ...
                <div class="p-6 rounded-lg border border-gray-200 relative" wire:key="option-{{$option->id}}">
                    ...
                    <div class="flex flex-wrap mb-4">
                        ...
                        @switch($option->type)
                            ...
                            <span class="bg-gray-100 text-gray-800 text-xs font-medium me-2 pl-2.5 pr-1.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-400 border border-gray-500">{{$feature->description}}
    ...
    <x-dialog-modal wire:model="newOption.openModal">
        ...
        <div class="flex justify-end">
            <x-button wire:click="addFeature" class="mb-2">
                Agregar valor
            </x-button>
        </div>
